...
import completeImg from '../assets/animoj.png'
...
function MainContent(props){
    ...
    <div id="iq" className={classes.total}>
      ...
      <div className={classes.section}>
        <span className={classes.animateUp} >Share your</span>
      </div>
      <div className={classes.section}>
        <span className={classes.animateUp} >favorite movies</span>
      </div>
      <div className={classes.section}>
      ...
      <svg id="Search_Icon" data-name="Search Icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <div id="movableNav" className={classes.movableNav}>
        {movableNav}
        </div>
...
const mapStateToProps=(state)=>{
  return {
    ...
    noResult: state.searchResults.error
  }
}
