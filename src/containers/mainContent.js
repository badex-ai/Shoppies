  ...
  const [searchTerm, setSearchTerm] = useState('Movie Title')
   ...
   useEffect(() => {
    ...
    const onHandleLoading=(event)=>{
      ...
      let share = showShare ? <button onClick={()=>onShareHandler()}  className = {classes.share}>share</button> : null;
      ...
      const completeOverlay = notif ? <div className={classes.completeOverlay}>
        <div className={classes.complete}>
          ...
          <img style={{width: '15rem'}}src="https://res.cloudinary.com/dkxbadex/image/upload/v1625273933/Reflick/animoj.png" alt="complete" />
          </div>
    ...
    let socialsSection = socials.openSocials ? <ul className={classes.socials}>
           
     {/* twitter        */}      
    <li className={classes.socialsicon}>
       ...
       <div id="movNav" className={classes.topNavMov}>
          ...
          <div className={classes.searchBarMov}><span className={classes.searchIcon}>
              ...
              <svg id="Search_Icon" data-name="Search Icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                ...
                </span><SearchMovies focus={(event)=>onFocusInput(event)} className={classes.searchMov}  onSubmit={(e)=>{onHandleLoading(e)}}></SearchMovies>
    ...
    <div id="iq" className={classes.total}>
      ...
      <svg id="Search_Icon" data-name="Search Icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <section className={classes.notifBar}>
          {nominationComplete}
        </section>
