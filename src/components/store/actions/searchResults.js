...
export const searchMovie=(movieTitle)=>{
    return dispatch=>{
        ...
        axios.get(`http://www.omdbapi.com/?i=tt3896198&apikey=${process.env.REACT_APP_OMDB_API}&s=${movieTitle}`).then(
            response=>{
...
export const fetchMoreMovies=(movieTitle,page)=>{
    return dispatch=>{
        ...
        axios.get(`http://www.omdbapi.com/?i=tt3896198&apikey=${process.env.REACT_APP_OMDB_API}&s=${movieTitle}&page=${page}`).then(
            response=>{
