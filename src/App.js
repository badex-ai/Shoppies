...
function App(props) {
  ...
  if (document.body.scrollTop > 353 || document.documentElement.scrollTop > 353) {
    document.querySelector("._1KURnOvqTfYNdcdxee_CV6").style.top = "0";
  } else {
    document.querySelector("._1KURnOvqTfYNdcdxee_CV6").style.top = "-100px";
  }
}
  ...
  let searchResults = props.searchResults ? props.searchResults.Search.map((mov)=>{
    ...
    return <SearchResult key={mov.imdbID} title={mov.Title} movieInfo={mov}></SearchResult>
     ...
     <div className={classes.initialText}>Your search results will appear here </div></div>;
  ...
  <g id="Remove_Icon" data-name="Remove Icon" transform="translate(2 2)">
   ...
   let nominatedMovieslist = props.nominatedMovies.length>0 ? props.nominatedMovies.map((el)=>{
     ...
     <div>
     <svg id="transporter-empty" xmlns="http://www.w3.org/2000/svg" width="90.796" height="90.796" viewBox="0 0 90.796 90.796">
   ...
   let socialsSection = socials.openSocials ? <div className={classes.socials}>
        ...
        <a href="/" className={classes.shareSection}>
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
        <g id="logo-facebook" transform="translate(0.318)">
          <rect id="Rectangle_50" data-name="Rectangle 50" width="32" height="32" transform="translate(-0.318)" fill="none"/>
          <g id="Group_75" data-name="Group 75" transform="translate(0.792 0.792)">
            <ellipse id="Ellipse_7" data-name="Ellipse 7" cx="15.5" cy="15" rx="15.5" ry="15" transform="translate(-0.11 0.208)" fill="#1877f2"/>
            <path id="Path_9" data-name="Path 9" d="M26.776,23.706l.677-4.415H23.217V16.427a2.207,2.207,0,0,1,2.489-2.385h1.926V10.283a23.445,23.445,0,0,0-3.419-.3c-3.489,0-5.769,2.114-5.769,5.943v3.365H14.566v4.415h3.878V34.379a15.41,15.41,0,0,0,4.773,0V23.706Z" transform="translate(-5.569 -4.146)" fill="#fff"/>
          </g>
        </g>
      </svg>
      <div>To facebook</div>
     ...
     <a href="https://twitter.com/intent/tweet?text=I%20just%20nominated%20my%20favorite%20movies%20on%20world.com" className={classes.shareSection}>
